...
function DimensionSection({ dim, idx }: { dim: any, idx: number }) {
    ...
    return (
        <div ref={sectionRef} className="w-full min-h-[70vh] flex items-center py-10 md:py-20 relative overflow-hidden border-b border-bio-panel last:border-b-0">

            <div className={`max-w-7xl mx-auto w-full px-4 md:px-8 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 items-center`}>
                ...
                >
                    <div className={`flex flex-col gap-4 mb-8 ${isEven ? "items-start" : "items-start md:items-end"}`}>
                    ...
                    <div className={`pt-8 border-t border-bio-panel w-full max-w-sm ${!isEven && "md:border-t-0 md:pt-0"}`}>
                        <div className={`flex flex-col gap-2 ${!isEven && "md:items-end"}`}>
                            <span className="block font-mono text-[14px] uppercase tracking-[0.3em] text-bio-primary/40">
                                SPECIFICATION_{dim.id}
                            </span>
                ...
                >
                    ...
                    <div className={`absolute -bottom-6 ${isEven ? "-left-6" : "-right-6"} hidden lg:block`}>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 mb-20">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-6xl font-sans font-medium tracking-tight text-bio-primary mb-8">
                        The Architecture of <span className="italic text-bio-primary/70">Control.</span>
                    </h2>
                    <p className="font-mono text-sm text-bio-primary/60 leading-relaxed">
                        We don't just grow materials; we design them at the cellular level. By manipulating the environment of the bioreactor, we command the structural outcome in four key dimensions.
                    </p>
                </motion.div>
            </div>
