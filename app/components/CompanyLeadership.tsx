        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            {[
              ...
              {
                name: "Prof. Dr. Dagmar Fischer",
                sub: "FAU, Erlangen–Nuremberg",
              },
              { name: "PD Dr. Wolfgang Fried", sub: "" },
            ].map((advisor, idx) => (
              <div key={idx} className="flex flex-col gap-2">
                <span className="font-sans text-2xl text-bio-primary">
                  {advisor.name}
                </span>
                {advisor.sub && (
                  <span className="font-mono text-[14px] tracking-[0.1em] text-bio-primary/40 uppercase">
                    {advisor.sub}
                  </span>
                )}
              </div>
