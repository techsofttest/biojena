        ...
        <section className="w-full bg-bio-bg py-16 md:py-32 px-4 md:px-8 text-center flex flex-col items-center relative overflow-hidden">
            ...
            >
                ...
                <p className="font-mono text-base md:text-lg leading-relaxed text-bio-primary/60 mb-20 max-w-2xl mx-auto">
                    A city with 450 years of scientific innovation, home to Carl Zeiss and generations of chemistry and biotech pioneers. Jena offers a deep biotech ecosystem, skilled workforce, and central European access to major cosmetic manufacturing hubs.
                </p>
                ...
                <div className="flex flex-col items-center gap-16">
                    ...
                    >
                        <strong className="text-bio-primary uppercase tracking-widest text-[14px] block mb-2">Company Information</strong>
                        <span className="text-bio-primary">BIOJENA GmbH</span><br />
                        Spitzweidenweg 30, 07743 Jena, Germany<br />
                        Email: <a href="mailto:contact@biojena.com" className="text-bio-primary hover:text-bio-accent transition-colors">contact@biojena.com</a> | Web: www.biojena.com<br />
                        Partnership Inquiries: <a href="mailto:contact@biojena.com" className="text-bio-primary hover:text-bio-accent transition-colors font-bold">contact@biojena.com</a>
                    </motion.div>
                </div>
            </motion.div>
        </section>
