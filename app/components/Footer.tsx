      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 border-b border-white/10 pb-24">
          ...
          <div className="md:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p className="font-mono text-sm leading-relaxed text-white/50 max-w-sm mt-4">
                Engineered purity. Materializing the future of sustainable,
                high-performance cosmetics through MMR technology.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-3">
            <h4 className="font-mono text-xs tracking-[0.3em] uppercase text-white/30 mb-10">
              Navigation
            </h4>
            <nav className="flex flex-col gap-5 font-sans text-sm font-medium tracking-wide">
              <Link
                href="/"
                className="hover:text-bio-accent transition-colors duration-300 w-fit"
              >
                Home
              </Link>
              <Link
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-8 font-mono text-sm">
              <div className="group">
                <span className="block text-[11px] text-white/30 uppercase tracking-widest mb-2">
                  Email Partnerships
                </span>
                <a
                  href="mailto:contact@biojena.com"
                  className="text-xl text-white hover:text-bio-accent transition-all duration-300 flex items-center gap-3"
                >
                  contact@biojena.com
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 gap-6 relative">
          <div className="flex items-center gap-4">
            ...
            <p className="font-mono text-xs tracking-widest text-white/30 uppercase">
              © {new Date().getFullYear()} BIOJENA Germany // All Systems
              Nominal
            </p>
          </div>
        </div>
