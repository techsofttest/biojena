    ...
    <section className="w-full bg-bio-bg py-10 md:py-20 px-4 md:px-8 text-center flex flex-col items-center relative overflow-hidden">
      ...
      >
        <h2 className="text-4xl md:text-5xl lg:text-7xl font-sans font-medium tracking-tight text-bio-primary mb-12">
          ...
          <span className="italic text-bio-primary/70">formulations?</span>
        </h2>
        <p className="font-mono text-sm md:text-base leading-relaxed text-bio-primary/70 mb-16 max-w-2xl mx-auto">
          Contact us to explore how MMR Technology with our Proprietary
          Bioreactors can solve your formulation challenges, or to discuss
          co-development opportunities for application-specific materials.
        </p>

        <div className="flex flex-col items-center gap-12">
          <Link href="mailto:contact@biojena.de">
            <Button variant="primary">Initiate Co-Development</Button>
          </Link>
          ...
          >
            Direct Inquiry:{" "}
            <span className="text-bio-primary ml-2">Vanessa Raddatz</span> //{" "}
            <a
              href="mailto:contact@biojena.de"
